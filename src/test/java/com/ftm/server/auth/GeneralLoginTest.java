...
public class GeneralLoginTest extends BaseTest {
    ...
    private ResultActions getResultActions(GeneralLoginRequest request) throws Exception {
    ...
    void setUp() {
        GeneralUserCreationCommand testCommand =
                GeneralUserCreationCommand.of(
                        ...
                        AgeGroup.TEENS,
                        null);
        User testUser = saveUserPort.saveUser(User.createGeneralUser(testCommand));
    ...
    void 유저_로그인_성공() throws Exception {
        ...
        GeneralLoginRequest request = new GeneralLoginRequest(email, password);
