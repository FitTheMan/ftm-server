...
public class BeautyProductJpaEntity extends BaseTimeJpaEntity {
    ...
    private BeautyProductJpaEntity(
    ...
    public static BeautyProductJpaEntity from(BeautyProduct beautyProduct) {
        return BeautyProductJpaEntity.builder()
                .productImageLink(beautyProduct.getProductImageLink())
                .beautyProductCategory(beautyProduct.getBeautyProductCategory())
                .brand(beautyProduct.getBrand())
                .name(beautyProduct.getName())
                .rating(beautyProduct.getRating())
                .productPageLink(beautyProduct.getProductPageLink())
                .build();
    }
}
